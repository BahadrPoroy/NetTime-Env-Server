...
- **Language settings have been activated.**
  ...
  - **on selection `language` is changing on real-time**
...
## 🚧 Roadmap & Work in Progress ## 
  ...
  - ### Future Plan About Settings Page ###
    - **~~Adding a slider for adjusting the screen brightness~~ It's done by buttons, slider is too complex for ESP8266 processor**
